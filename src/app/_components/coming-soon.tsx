  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
      ...
      <p className="mt-4 font-display text-lg tracking-wider text-foreground/80">
        Something amazing is on the horizon. Stay tuned.
      </p>
      ...
      <div className="mt-12 flex items-center gap-2">
        <div className="h-2 w-2 animate-pulse rounded-full bg-primary shadow-[0_0_10px_var(--primary)]" />
        <span className="font-mono text-[10px] tracking-wider text-primary">LOADING...</span>
      </div>
    </div>
  )
}
